...
void giveMeSphe_10us(int channel = 0){
    ...
    dark.start  = 2100;            // start the search for peaks or start the integration (led)
    dark.finish = 2700;        // fisish the search or finish the integration (led)
    ...
    dark.spe_max_val_at_time_cut = 7; // after `time_cut`, the signal cannot be higher than this
                                       // this allows to remove after pulses
    dark.time_cut = 3200; // in ns seconds
